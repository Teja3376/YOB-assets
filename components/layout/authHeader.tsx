...
const ProfilePopover = (router: any) => {
  ...
  return (
    <Popover>
      ...
      <PopoverContent
        sideOffset={10}
        className=" z-10 w-50 mr-2 px-4 py-2 rounded-lg shadow-lg border border-gray-200  bg-white"
      >
...
export default function AuthHeader({ hideNavigation = false }: HeaderProps) {
  ...
  console.log("User data in AuthHeader:", user?.data, isLoading);
