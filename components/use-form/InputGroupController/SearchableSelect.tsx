  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          type="button"
          className={`w-full h-9 border rounded-md flex items-center justify-between px-2 bg-white ${
          ...
          {selected ? (
            <div className="inline-flex items-center gap-2 text-xs">
              <div className="flex items-center h-6 w-6">
                {selected.iso2 &&
                  flags[selected.iso2] &&
                  React.createElement(flags[selected.iso2], { title: "" })}
              </div>
              ...
              >
                <div className="flex items-center gap-2 text-xs">
                  <div className="flex items-center h-6 w-6 ">
                    {option.iso2 &&
                      flags[option.iso2] &&
                      React.createElement(flags[option.iso2], { title: "" })}
                  </div>
