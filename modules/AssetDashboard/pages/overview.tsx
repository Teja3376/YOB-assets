...
import { OverviewMetrics } from "../components/Overview/OverviewMetrix";
import { PropertyDetails } from "../components/Overview/PropertyDetails";
import { TokenInformation } from "../components/Overview/TokenInformation";
import AssetHost from "../components/Overview/AssetHost";
...
const Overview: React.FC<OverviewProps> = ({
  ...
  const handleViewOnBlockchain = () => {
    window.open(`https://testnet.xdcscan.com/address/${assetOverview?.tokenInformation?.blockchainProjectAddress}`);
  };
    ...
    <div className='border border-gray-200 bg-white p-6 rounded-lg'>
      <div className='flex justify-between items-center mb-2'>
        ...
        <div className='flex space-x-2'>
          ...
          <button className='flex items-center px-3 py-1.5 text-sm border rounded-md' onClick={handleViewOnBlockchain}>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              className='h-4 w-4 mr-1'
              fill='none'
