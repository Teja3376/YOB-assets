    ...
    <div className="border rounded-md">
      <div className="px-4 py-2 bg-primary/10 rounded-t-md ">
        <h1 className="text-md font-medium">
          Order Breakdown <span className="text-xs text-muted-foreground">(User Currency-{userCurrency})</span>
        </h1>
      </div>
      <hr />
      <div className="text-sm  flex justify-between px-4 py-3">
        ...
        <p className="font-semibold">
          {formatCurrencyWithLocale(tokenValue, userCurrency)}
        </p>
      </div>
      <hr />
      ...
      <div className="text-md flex justify-between p-4">
        ...
        <p className="font-semibold">
          {formatCurrencyWithLocale(totalPaid, userCurrency)}
        </p>
      </div>
    </div>
  );
