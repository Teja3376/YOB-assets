...
export const tenantFormConfig = (index: number): FormFieldConfig[] => {
  ...
  return [
    ...
    },
    {
      ...
      control,
      label: "Start Date",
      allowFutureDates: true, // Allow future dates for start date
      autoClose:true
    },
    {
      type: "date",
      ...
      control,
      label: "End Date",
      allowFutureDates: true, // Allow future dates for end date
      autoClose:true
    },
