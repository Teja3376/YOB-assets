...
const Index: React.FC = () => {
    ...
    const { data: assetList, isLoading } = useAssetList({ status: assetStatus, page: currentPage, limit: limit });
    const columns = getColumns(setAsset, setNewStatus);

    const onPageChange = (page: number) => {
        router.push(`${pathname}?status=${assetStatus}&page=${page}&limit=${limit}`);
    };
    ...
    const tabs = [
        {
            id: "active",
            title: "Active",
            component: <AssetTable columns={columns} assetList={assetList?.data || []} />,
        },
        {
            id: "draft",
            title: "Drafts",
    ...
    return (
        <div className="p-4 space-y-2">
            ...
            <div className="space-y-4">
                ...
                />
                {assetList?.pagination && <Pagination
